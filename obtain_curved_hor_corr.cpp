...
vector<double> Obtain_Curved_Hor_Corr::horCorr(double y_pro_C1, double y_max_C1, double z_pro_C1, double z_max_C1, bool type_c){

    double R_cur_crys_t;

    if(type_c)
        R_cur_crys_t = Curved_Crystal.R_cur_crys_1;
    else
        R_cur_crys_t = Curved_Crystal.R_cur_crys_2;
